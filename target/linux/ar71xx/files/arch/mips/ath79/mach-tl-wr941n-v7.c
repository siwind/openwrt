 ...
 *  TP-LINK TL-WR2041N v2/TL-WR880N v1/TL-WR881N v1 board support
 *
...
MIPS_MACHINE(ATH79_MACH_TL_WR941N_V7, "TL-WR941N-v7","TP-LINK TL-WR941N v7", wr941nv7_setup);

/* 2041n v2 board support*/
MIPS_MACHINE(ATH79_MACH_TL_WR2041N_V2, "TL-WR2041N-v2","TP-LINK TL-WR2041N v2", wr941nv7_setup);

/* 880n v1 board support*/
MIPS_MACHINE(ATH79_MACH_TL_WR880N_V1, "TL-WR880N-v1","TP-LINK TL-WR880N v1", wr941nv7_setup);

/* 881n v1 board support*/
MIPS_MACHINE(ATH79_MACH_TL_WR881N_V1, "TL-WR881N-v1","TP-LINK TL-WR881N v1", wr941nv7_setup);
